...
public class InviteController {
	...
	public ResponseEntity<ResponseDto<String>> acceptInvite(@RequestParam String meetingId, @RequestParam String codicePersona) {
	...
	public ResponseEntity<ResponseDto<String>> declineInvite(@RequestParam String meetingId, @RequestParam String codicePersona) {
